...
export default function LandingPageIIUMFreelancer() {
  return (
    <>
      <div className="h-screen bg-gradient-to-tl from-green-400">
        <header className="p-6 px-20 flex justify-between shadow-md sticky z-10 w-full bg-white">
        ...
        <section className="grid md:lg:grid-cols-2 p-20 md:lg:px-40  justify-items-center ">
